/*jslint node: true */
"use strict";
var conf = require('fortunechaincore/conf.js');
var db = require('fortunechaincore/db.js');
var storage = require('fortunechaincore/storage.js');
var eventBus = require('fortunechaincore/event_bus.js');
var mail = require('fortunechaincore/mail.js');
var headlessWallet = require('headless-fortunechain');
var desktopApp = require('fortunechaincore/desktop_app.js');
var objectHash = require('fortunechaincore/object_hash.js');
...
function witness(onDone){
	...
	var network = require('fortunechaincore/network.js');
	var composer = require('fortunechaincore/composer.js');
